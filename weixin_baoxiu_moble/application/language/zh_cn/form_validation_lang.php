...
$lang['is_unique'] 			= "<strong>%s</strong>  必须是唯一值";
$lang['is_natural']			= "<strong>%s</strong>  必须是自然数(非负整数)";
$lang['is_natural_no_zero']	= "<strong>%s</strong>  必须是大于零的自然数(非负整数)";
$lang['decimal']			= "<strong>%s</strong>  必须是小数";
$lang['less_than']			= "<strong>%s</strong>  必须是小于%s的数字";
$lang['greater_than']		= "<strong>%s</strong>  必须是小于%s的数字";
