...
<form role="form" action="<?php echo site_url('user/checkLogin') ?>" onsubmit="return form_Validator(this)" method="post" name="form" >
  ...
  <div class="form-group has-success">
    ...
    <input type="text" class="form-control input-lg" style="border-radius:20px;padding-left:90px;border-color:rgba(255, 255, 255, 0.69);background:transparent;color:white;" id="sn" placeholder="请输入学号" name="sn" value="" maxlength="10">
  </div>
  <!--密码-->
  <div class="form-group has-success">

    <input type="password" class="form-control input-lg" style="border-radius:20px;padding-left:90px;border-color:rgba(255, 255, 255, 0.69);background:transparent;color:white;" id="password" placeholder="请输入密码" name="password" maxlength="15" value="">
  </div>
