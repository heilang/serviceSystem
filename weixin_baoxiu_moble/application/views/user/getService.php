  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <?php
echo '<img class="img-responsive" title="相关图片" width="100%" height="100%" src="http://localhost/weixin_baoxiu//uploads/'.$row->filename.'"  />';
?>
</div>
...
<td colspan="4" ><a href="#otherModal<?php echo $a ?>"  data-toggle="modal" data-target="#otherModal<?php echo $a ?>">
  <?php
    echo '<img class="img-responsive" title="相关图片" width="40%" height="40%" src="http://localhost/weixin_baoxiu//uploads/'.$row->filename.'"  />';
    } 
    ?>
